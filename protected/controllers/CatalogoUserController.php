...
class CatalogoUserController extends Controller
{
	/**
	...
	{
		$model=CatalogoUser::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='catalogo-user-form')
		{
