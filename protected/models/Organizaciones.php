...
class Organizaciones extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_organizacion, organizacion, descripcion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'pcorganizacionesCes' => array(self::HAS_MANY, 'PcorganizacionesCe', 'id_organizacion'),
		);
	}
