  ...
  $(document).ready(function() {
	  $('#catalogoespecies-form').keydown(function(event){
		  if(event.keyCode == 13) {
			  ...
			  if(target.id == "Attribute_referencia_bibliografica_filter_id") {
			  	event.preventDefault();
				  $("#Attribute_referencia_bibliografica_filter_id").trigger("change");
				  return false;	
			  }
			  if(target.id == "Attribute_referencia_bibliografica_filter_fecha") {
			  	event.preventDefault();
				  $("#Attribute_referencia_bibliografica_filter_fecha").trigger("change");
				  return false;	
			  }
			  if(target.id == "Attribute_referencia_bibliografica_filter_documento_titulo") {
			  	event.preventDefault();
				  $("#Attribute_referencia_bibliografica_filter_documento_titulo").trigger("change");
				  return false;	
			  }
