	...
	'components'=>array(
		...
		'urlManager'=>array(
			...
			'rules'=>array(
				...
				array('api/listPreviewWithImagesRandomInvasoras', 'pattern'=>'api/fichas/previewrandomspeciesinvasoras', 'verb'=>'GET'),
				array('api/carrusel', 'pattern'=>'api/fichas/<model:\w+>', 'verb'=>'GET'),
				array('api/pdfCompiler', 'pattern'=>'api/pdfCompiler/<id:\d+>', 'verb'=>'GET'),
				array('api/licence', 'pattern'=>'api/licence/<id:\d+>', 'verb'=>'GET'),
